...
class AuthorizedCheck: NSObject {
    ...
    static func showMicrophoneUnauthorizedAlert(_ viewController: UIViewController) {
        let title: String = ZGUIKitLocalizedString("dialog_login_page_mic_cant_open")
        let message: String = ZGUIKitLocalizedString("dialog_login_page_mic_permission")
    ...
    static func showCameraUnauthorizedAlert(_ viewController: UIViewController) {
        ...
        let title: String = ZGUIKitLocalizedString("dialog_login_page_title_cannot_use_camera")
        let message: String = ZGUIKitLocalizedString("dialog_login_page_massage_cannot_use_camera")
        DispatchQueue.main.async {
            showAlert(title, message, viewController) {
                openAppSettings()
            }
    ...
    private static func showAlert(_ title: String,
        ...
        let cancelAction = UIAlertAction(title: ZGUIKitLocalizedString("dialog_login_page_cancel"), style: .cancel, handler: nil)
        let okAction = UIAlertAction(title: ZGUIKitLocalizedString("dialog_login_page_go_to_settings"), style: .default) { action in
            okCompletion()
        }
